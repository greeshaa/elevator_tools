...
before_filter :signed_in_user
  ...
  def main
    ...
    inspection_rebuke         = Inspection.where(active: true).where(rebuke: true)
    @inspection_rebuke        = inspection_rebuke.first(3)
    @inspection_rebuke_count  = inspection_rebuke.count
